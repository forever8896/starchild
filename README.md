...
The full scaffold — Tauri app shell, React frontend, Rust backend with Venice AI client, SQLite schema, Telegram/WhatsApp bot connectors, and the agency framework itself — was produced by this multi-agent system.
...
- The only outbound network call is AI inference to Venice — nothing else leaves the device
- End-to-end encryption module (AES-256-GCM + HKDF) for cross-device sync
- No telemetry, no analytics, no tracking, no blockchain
