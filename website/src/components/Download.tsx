...
const downloadButtons = [
  { label: "Download for Mac", sublabel: "macOS 12+", icon: <AppleIcon />, href: "#" },
  { label: "Download for Windows", sublabel: "Windows 10+", icon: <WindowsIcon />, href: "#" },
  { label: "Download for Linux", sublabel: ".deb / .AppImage", icon: <LinuxIcon />, href: "#" },
];
