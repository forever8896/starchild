...
const downloadButtons = [
  { label: "Download for Mac", icon: <AppleIcon />, href: `${RELEASE}/starchild_0.2.0_aarch64.dmg` },
  { label: "Download for Windows", icon: <WindowsIcon />, href: `${RELEASE}/starchild_0.2.0_x64-setup.exe` },
  { label: "Download for Linux", icon: <LinuxIcon />, href: `${RELEASE}/starchild_0.2.0_amd64.AppImage` },
];
